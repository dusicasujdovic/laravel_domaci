   ...
   /* public function destroy($book)
...

    {
        ...
        if ($book) {
             ...
             return response()->json(['You have successfully deleted the book!', new BookResource($book)]);

        }

        else {

             return response()->json('It is not possible to find the book in the database by the given id!');
